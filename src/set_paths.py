...
def create_path_dict(define_user=False, user=None):
    ...
    paths_dict = {
        **paths_dict,
        ...
        "start_params": analysis_path
        + "src/estimation/struct_estimation/start_params/start_params.yaml",
        "est_params": analysis_path + "output/est_results/est_params.pkl",
        "intermediate_est_data": analysis_path + "output/intermediate_data/estimation/",
