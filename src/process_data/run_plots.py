...
plot_savings_rate(
    path_dict, specs, covariate="partner", show=show_plots, save=save_plots, window=5
)
...
plot_state_by_age_and_type(
    path_dict, state_vars, specs, show=show_plots, save=save_plots
)
