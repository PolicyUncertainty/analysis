...
def plot_children(path_dict, specs, show=False, save=False):
    ...
    if save:
        ...
        fig.savefig(path_dict["first_step_plots"] + "children.png", bbox_inches="tight", dpi=300)
...
def plot_marriage_and_divorce(path_dict, specs, show=False, save=False):
    ...
    if save:
        fig.savefig(path_dict["first_step_plots"] + "partner_lifecycle.pdf", bbox_inches="tight")
        fig.savefig(path_dict["first_step_plots"] + "partner_lifecycle.png", bbox_inches="tight", dpi=300)
