...
def plot_utility(path_dict, params, specs, show=False, save=False):
    ...
    if save:
        fig.savefig(path_dict["model_plots"] + "utility_function.pdf", bbox_inches="tight")
        fig.savefig(path_dict["model_plots"] + "utility_function.png", bbox_inches="tight", dpi=300)
...
def plot_bequest(path_dict, params, specs, show=False, save=False):
    ...
    if save:
        fig.savefig(path_dict["model_plots"] + "bequest_utility.pdf", bbox_inches="tight")
        fig.savefig(path_dict["model_plots"] + "bequest_utility.png", bbox_inches="tight", dpi=300)
...
def plot_cons_scale(path_dict, specs, show=False, save=False):
    ...
    if save:
        fig.savefig(path_dict["model_plots"] + "consumption_scale.pdf", bbox_inches="tight")
        fig.savefig(path_dict["model_plots"] + "consumption_scale.png", bbox_inches="tight", dpi=300)
