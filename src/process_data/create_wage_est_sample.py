...
from process_data.create_structural_est_sample import (
...
def create_wage_est_sample(paths, options, load_data=False):
    ...
    print(str(len(merged_data)) + " observations after dropping non-working individuals.")
    ...
    print(str(len(merged_data)) + " observations after dropping invalid experience values.")
