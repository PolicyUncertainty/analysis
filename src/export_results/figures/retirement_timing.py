...
def plot_retirement_timing_data(paths, params, specs):
    ...
    fresh_retirees = struct_est_sample[(struct_est_sample["choice"] == 0) & (struct_est_sample["lagged_choice"] != 0)]
    ...
    fresh_retirees["SRA"] = specs["min_SRA"] + fresh_retirees["policy_state"] * specs["SRA_grid_size"]
    fresh_retirees["actual_ret_age_vs_SRA"] = fresh_retirees["age"] - fresh_retirees["SRA"]
