...
def get_next_period_experience(
    period, lagged_choice, policy_state, sex, education, experience, informed, partner_state, options
):
...
def calc_experience_years_for_pension_adjustment(
    period, sex, experience_years, education, policy_state, informed, partner_state, options
):
    ...
    very_long_insured_test = test_very_long_insured(retirement_age_difference, experience_years, sex, education, partner_state, options)
    early_retirement_penalty = (
        informed * early_retirement_penalty_informed
        + (1 - informed) * early_retirement_penalty_uninformed
    )
    early_retirement_penalty = 1 - early_retirement_penalty * retirement_age_difference*(1-very_long_insured_test)
...
def test_very_long_insured(retirement_age_difference, experience_years, sex, education, partner_state, options):
    """Test if the individual qualifies for pension for very long insured
    (Rente besonders für langjährig Versicherte)."""
    qualified_years = get_qualified_years(experience_years, sex, education, partner_state)
