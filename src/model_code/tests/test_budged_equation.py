...
SAVINGS_GRID_UNEMPLOYED = np.linspace(10, 25, 15)
PARTNER_STATES = np.array([0], dtype=int)
PERIOD_GRID = np.arange(0, 65, 15, dtype=int)
OLD_AGE_PERIOD_GRID = np.arange(25, 43, 15, dtype=int)
VERY_OLD_AGE_PERIOD_GRID = np.arange(35, 43, 5, dtype=int)
EDUCATION_GRID = [0]
SEX_GRID = [0]
